    ...
    <div class="pc-content">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('manager.mess-menus.create') }}" class="btn btn-primary">
                    Create Menu
                </a>
            </div>
            ...
            <div class="card-body">
                <form method="GET" class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="{{ route('manager.mess-menus.index') }}" class="btn btn-light">Reset</a>
                    </div>
                </form>
                        ...
                        <tbody>
                            @forelse($messMenus as $menu)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('manager.mess-menus.show', $menu) }}"
                                            class="btn btn-sm btn-info">View</a>
                                        <a href="{{ route('manager.mess-menus.edit', $menu) }}"
                                            class="btn btn-sm btn-warning">Edit</a>

                                        <form action="{{ route('manager.mess-menus.destroy', $menu) }}" method="POST"
                                            class="d-inline" onsubmit="return confirm('Delete this menu?')">
                                            @csrf
                                            @method('DELETE')
