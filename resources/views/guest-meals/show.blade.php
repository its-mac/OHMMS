...
<div class="card">
    <div class="card-body">
        <table class="table table-bordered">
            <tr><th width="200">Student</th><td>{{ $guestMeal->student->name ?? '-' }}</td></tr>
            <tr><th>Registration No</th><td>{{ $guestMeal->student->registration_no ?? '-' }}</td></tr>
            <tr><th>Meal Date</th><td>{{ \Carbon\Carbon::parse($guestMeal->meal_date)->format('d M Y') }}</td></tr>
        ...
        <a href="{{ route('admin.guest-meals.index') }}" class="btn btn-light">Back</a>
    </div>
</div>
@endsection
