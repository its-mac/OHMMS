    ...
    <div class="page-block">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-end mt-3 mt-md-0">
                <a href="{{ route('admin.room-allocations.create') }}" class="btn btn-primary">
                ...
                <tbody>
                    @forelse($allocations as $allocation)
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{ route('admin.room-allocations.show', $allocation) }}"
                                   class="btn btn-sm btn-light-primary">View</a>

                                <a href="{{ route('admin.room-allocations.edit', $allocation) }}"
                                   class="btn btn-sm btn-light-warning">Edit</a>

                                <form action="{{ route('admin.room-allocations.destroy', $allocation) }}"
                                      method="POST"
                                      class="d-inline"
