...
setTimeout(function () {
    (function () {
        ...
        getDayWiseTimeSeries(new Date('11 Jul 2025 GMT').getTime(), 10, {
            min: 10,
            max: 90
        });
        ...
        var options = {
            ...
            xaxis: {
                type: 'datetime',
                min: new Date('01 Jul 2025').getTime(),
                tickAmount: 6
            },
            tooltip: {
                x: {
        ...
        document.querySelector('#one_month').addEventListener('click', function (e) {
            ...
            chart.updateOptions({
                xaxis: {
                    min: new Date('28 Jul 2025').getTime(),
                    max: new Date('27 Aug 2025').getTime()
                }
            });
        });
        document.querySelector('#six_months').addEventListener('click', function (e) {
            ...
            chart.updateOptions({
                xaxis: {
                    min: new Date('27 Jan 2025').getTime(),
                    max: new Date('27 Jul 2025').getTime()
                }
            });
        });
        document.querySelector('#one_year').addEventListener('click', function (e) {
            ...
            chart.updateOptions({
                xaxis: {
                    min: new Date('27 Jul 2024').getTime(),
                    max: new Date('27 Jul 2025').getTime()
                }
            });
        });
        ...
        var options_bar_chart_2 = {
            ...
            xaxis: {
                type: 'datetime',
                categories: ['01/01/2025 GMT', '01/02/2025 GMT', '01/03/2025 GMT', '01/04/2025 GMT', '01/05/2025 GMT', '01/06/2025 GMT']
            },
            legend: {
                position: 'bottom'
            },
        ...
        var options_bar_chart_3 = {
            ...
            xaxis: {
                categories: [2025, 2025, 2025, 2022, 2023, 2024, 2025]
            }
        };
        ...
        var options_bubble_chart_1 = {
            ...
            series: [
                {
                    name: 'Bubble1',
                    data: generateBubbleData(new Date('11 Jul 2025 GMT').getTime(), 20, {
                        min: 10,
                        max: 60
                    })
                },
        ...
        var options_bubble_chart_2 = {
            ...
            series: [
                {
                    name: 'Product1',
                    data: generateDatasehratheatbubble3d(new Date('11 Jul 2025 GMT').getTime(), 20, {
                        min: 10,
                        max: 60
                    })
                },
        ...
        var options_scatter_chart_2 = {
            ...
            series: [
                {
                    name: 'TEAM 1',
                    data: generateDayWiseTimeSeries(new Date('11 Jul 2025 GMT').getTime(), 20, {
                        min: 10,
                        max: 60
                    })
                },
                ...
                {
                    name: 'TEAM 3',
                    data: generateDayWiseTimeSeries(new Date('11 Jul 2025 GMT').getTime(), 30, {
                        min: 10,
                        max: 60
                    })
                },
                {
                    name: 'TEAM 4',
                    data: generateDayWiseTimeSeries(new Date('11 Jul 2025 GMT').getTime(), 10, {
                        min: 10,
                        max: 60
                    })
                },
        ...
        var options_radar_chart_2 = {
            ...
            labels: ['2025', '2025', '2022', '2023', '2024', '2025']
        };
