...
!function (e, t) {
    ...
    const o = {}
        , i = e => new Promise(t => {
            ...
            o.restoreFocusTimeout = setTimeout(() => {
                o.previousActiveElement instanceof HTMLElement ? (o.previousActiveElement.focus(),
                    o.previousActiveElement = null) : document.body && document.body.focus(),
                    t()
            }
                , 100),
                window.scrollTo(n, i)
        ...
        , K = (e, t) => {
            ...
            for (let e = 0; e < n.length; e++) {
                const o = n[e];
                if (o instanceof HTMLElement && N(o, t))
                    return o
            }
        }
        , Y = (e, t, n) => {
            n === `${parseInt(`${n}`)}` && (n = parseInt(n)),
                n || 0 === n ? e.style.setProperty(t, "number" == typeof n ? `${n}px` : n) : e.style.removeProperty(t)
        }
        , X = (e, t = "flex") => {
            e && (e.style.display = t)
        }
        ...
        , ee = e => Boolean(e && (e.offsetWidth || e.offsetHeight || e.getClientRects().length))
        ...
        , oe = (e, t = !1) => {
            const n = H();
            n && ee(n) && (t && (n.style.transition = "none",
                n.style.width = "100%"),
                setTimeout(() => {
        ...
        , re = e => {
            const t = (() => {
                const e = y();
                return !!e && (e.remove(),
                    W([document.documentElement, document.body], [r["no-backdrop"], r["toast-shown"], r["has-column"]]),
                    !0)
            }
            )();
            ...
            i.appendChild(n),
                e.topLayer && (n.setAttribute("popover", ""),
                    n.showPopover()),
                (e => {
                    const t = C();
        ...
        , ue = (e, t) => {
            const n = O()
                , o = S();
            n && o && (t.showConfirmButton || t.showDenyButton || t.showCancelButton ? X(n) : Z(n),
                _(n, t, "actions"),
                function (e, t, n) {
                    const o = P()
                        , i = T()
                    ...
                    de(o, "confirm", n),
                        ...
                        function (e, t, n, o) {
                            ...
                            z([e, t, n], r.styled);
                            const i = [[e, "confirm", o.confirmButtonColor], [t, "deny", o.denyButtonColor], [n, "cancel", o.cancelButtonColor]];
                            i.forEach(([e, t, n]) => {
                        ...
                        n.reverseButtons && (n.toast ? (e.insertBefore(s, o),
                            e.insertBefore(i, o)) : (e.insertBefore(s, t),
                                e.insertBefore(i, t),
                                e.insertBefore(o, t)))
                }(n, o, t),
                q(o, t.loaderHtml || ""),
    ...
    const pe = (e, t) => {
        ...
        n && (!function (e, t) {
            ...
            function (e, t) {
                if (!t)
                    return;
                t in r ? z(e, r[t]) : (u('The "position" parameter is not valid, defaulting to "center"'),
                    z(e, r.center))
            }(n, t.position),
            function (e, t) {
                if (!t)
    ...
    const he = ["input", "file", "range", "select", "radio", "checkbox", "textarea"]
        , ge = e => {
            if (!e.input)
                return;
            if (!Ae[e.input])
                return void d(`Unexpected type of input! Expected ${Object.keys(Ae).join(" | ")}, got "${e.input}"`);
            const t = we(e.input);
            if (!t)
                return;
        ...
        , Ae = {};
    Ae.text = Ae.email = Ae.password = Ae.number = Ae.tel = Ae.url = Ae.search = Ae.date = Ae["datetime-local"] = Ae.time = Ae.week = Ae.month = (e, t) => {
        const n = e;
        return Ce(n, t.inputValue),
            ve(n, n, t),
            ye(n, t),
            n.type = t.input,
            n
    ...
    const Ee = (e, t) => {
        ...
        n && (J(n),
            _(n, t, "htmlContainer"),
            t.html ? (ae(t.html, n),
                X(n, "block")) : t.text ? (n.textContent = t.text,
                    X(n, "block")) : Z(n),
            ((e, t) => {
                const n = C();
                if (!n)
    ...
    const He = e => {
        ...
        , Ve = (e, t) => {
            ...
            if (n && o) {
                ...
                Y(o, "padding", t.padding),
                    ...
                    Z(L()),
                    qe(o, t),
                    t.draggable && !t.toast ? (z(o, r.draggable),
                        (e => {
        ...
        , qe = (e, t) => {
            ...
            e.className = `${r.popup} ${ee(e) ? n.popup : ""}`,
                t.toast ? (z([document.documentElement, document.body], r["toast-shown"]),
                    z(e, r.toast)) : z(e, r.modal),
                _(e, t, "popup"),
        ...
        , Ne = e => {
            ...
            return z(t, r["progress-step"]),
                q(t, e),
                t
        }
        , _e = e => {
            const t = document.createElement("li");
            return z(t, r["progress-step-line"]),
            ...
            Ve(0, t),
                ...
                ((e, t) => {
                    ...
                    if (t.icon && -1 === Object.keys(a).indexOf(t.icon))
                        return d(`Unknown icon! Expected "success", "error", "warning", "info" or "question", got "${t.icon}"`),
                            void Z(o);
                    X(o),
                        $e(o, t),
                        ke(o, t),
                        z(o, t.showClass && t.showClass.icon),
                        window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", Be)
                }
                )(e, t),
                ((e, t) => {
                    const n = B();
        ...
        , We = (e, t) => {
            var n;
            const o = I();
            return o.length ? (-2 === (e += t) && (e = o.length - 1),
                e === o.length ? e = 0 : -1 === e && (e = o.length - 1),
                o[e].focus(),
                !(navigator.userAgent.includes("Firefox") && o[e] instanceof HTMLIFrameElement)) : (null === (n = C()) || void 0 === n || n.focus(),
                    !0)
        }
        ...
        , Xe = (e, t, n) => {
            e && (t.isComposing || 229 === t.keyCode || (e.stopKeydownPropagation && t.stopPropagation(),
                "Enter" === t.key ? Ze(t, e) : "Tab" === t.key ? Je(t) : [...Ke, ...Ye].includes(t.key) ? Ge(t.key) : "Escape" === t.key && Qe(t, e, n)))
        }
        , Ze = (e, t) => {
            ...
            if (a) {
                for (let e = 0; e < t.children.length; e++) {
                    if (a = a[r],
                        !a)
                        return;
                    if (a instanceof HTMLButtonElement && ee(a))
                        break
                }
    ...
    const tt = () => {
        ...
        , rt = e => Boolean(e.touches && e.touches.length && "stylus" === e.touches[0].touchType)
        , at = e => e.touches && e.touches.length > 1;
    let lt = null;
    const ct = e => {
        null === lt && (document.body.scrollHeight > window.innerHeight || "scroll" === e) && (lt = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")),
            document.body.style.paddingRight = `${lt + (() => {
        ...
        ;
    function ut(e, t, n, s) {
        V() ? yt(e, s) : (i(n).then(() => yt(e, s)),
            ze(o)),
            nt ? (t.setAttribute("style", "display:none !important"),
                t.removeAttribute("class"),
                t.innerHTML = "") : t.remove(),
            D() && (null !== lt && (document.body.style.paddingRight = `${lt}px`,
                lt = null),
                (() => {
    ...
    function dt(e) {
        ...
        const t = et.swalPromiseResolve.get(this)
            , n = pt(this);
        this.isAwaitingPromise ? e.isDismissed || (ht(this),
            t(e)) : n && t(e)
    }
    const pt = e => {
        const t = C();
        ...
        W(t, n.showClass.popup),
            z(t, n.hideClass.popup);
        const o = y();
        return W(o, n.showClass.backdrop),
    ...
    const ht = e => {
        ...
        , ft = (e, t, n) => {
            ...
            "function" == typeof n.willClose && n.willClose(t),
                ...
                r && s ? bt(e, t, s, Boolean(n.returnFocus), n.didClose) : s && ut(e, s, Boolean(n.returnFocus), n.didClose)
        }
        , bt = (e, t, n, i, s) => {
            o.swalCloseEventFinishedCallback = ut.bind(null, e, n, i, s);
            const r = function (e) {
                var n;
                e.target === t && (null === (n = o.swalCloseEventFinishedCallback) || void 0 === n || n.call(o),
        ...
        , kt = (e, t) => {
            ...
            const o = e => {
                ...
                ;
            g(t.inputOptions) || b(t.inputOptions) ? (vt(P()),
        ...
        ;
    const $t = e => (e instanceof Map ? Array.from(e) : Object.entries(e)).map(([e, t]) => [e, "object" == typeof t ? $t(t) : t])
        , Lt = (e, t) => Boolean(t) && null != t && t.toString() === e.toString()
        , Pt = (e, t) => {
            const n = me.innerParams.get(e);
            if (!n.input)
                return void d(`The "input" parameter is needed to be set when using returnInputValueOn${c(t)}`);
            const o = e.getInput()
                , i = ((e, t) => {
                    const n = e.getInput();
                    if (!n)
            ...
            n.inputValidator ? xt(e, i, t) : o && !o.checkValidity() ? (e.enableButtons(),
                e.showValidationMessage(n.validationMessage || o.validationMessage)) : "deny" === t ? Tt(e, i) : Mt(e, i)
        }
        , xt = (e, t, n) => {
            const o = me.innerParams.get(e);
            e.disableInput();
        ...
        , Mt = (e, t) => {
            const n = me.innerParams.get(e);
            if (n.showLoaderOnConfirm && vt(),
                n.preConfirm) {
                e.resetValidationMessage(),
                    e.isAwaitingPromise = !0;
                Promise.resolve().then(() => f(n.preConfirm(t, n.validationMessage))).then(n => {
                    ee(L()) || !1 === n ? (e.hideLoading(),
                        ht(e)) : St(e, void 0 === n ? t : n)
                }
                ).catch(t => Ot(e, t))
            } else
                St(e, t)
    ...
    const jt = e => {
        ...
        n.length ? X(n[0], "inline-block") : ee(P()) || ee(T()) || ee(x()) || Z(e.actions)
    }
        ;
    function It() {
        const e = me.innerParams.get(this)
    ...
    const zt = {
        ...
        , tn = e => {
            !1 === e.backdrop && e.allowOutsideClick && u('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
                e.theme && !["light", "dark", "auto", "minimal", "borderless", "bootstrap-4", "bootstrap-4-light", "bootstrap-4-dark", "bootstrap-5", "bootstrap-5-light", "bootstrap-5-dark", "material-ui", "material-ui-light", "material-ui-dark", "embed-iframe", "bulma", "bulma-light", "bulma-dark"].includes(e.theme) && u(`Invalid theme "${e.theme}"`);
            for (const t in e)
                Gt(t),
                    e.toast && Qt(t),
                    en(t)
    ...
    const on = e => {
        ...
        return Object.keys(e).forEach(n => {
            if (Zt(n)) {
                ...
                u(`Invalid parameter to update: ${n}`)
        }
        ),
            t
    }
    ...
    function sn() {
        ...
        const t = me.domCache.get(this)
            , n = me.innerParams.get(this);
        n ? (t.popup && o.swalCloseEventFinishedCallback && (o.swalCloseEventFinishedCallback(),
            delete o.swalCloseEventFinishedCallback),
    ...
    const rn = e => {
        ...
        , an = e => {
            e.isAwaitingPromise ? (ln(me, e),
                e.isAwaitingPromise = !0) : (ln(et, e),
                    ln(me, e),
    ...
    const un = (e, t, n) => {
        ...
        , dn = e => Boolean(e.showConfirmButton || e.showDenyButton || e.showCancelButton || e.showCloseButton);
    let pn = !1;
    const mn = e => {
        e.popup.onmousedown = () => {
        ...
        , gn = (e, t, n) => {
            t.container.onclick = o => {
                pn ? pn = !1 : o.target === t.container && h(e.allowOutsideClick) && n(Ue.backdrop)
            }
        }
        , fn = e => e instanceof Element || (e => "object" == typeof e && null !== e && "jquery" in e)(e);
    const bn = () => {
        if (o.timeout)
            return (() => {
                const e = H();
    ...
    var An = Object.freeze({
        ...
        bindClickHandler: function (e = "data-swal-template") {
            wn[e] = this,
                vn || (document.body.addEventListener("click", Cn),
                    vn = !0)
        },
        clickCancel: () => {
            var e;
        ...
        off: (e, t) => {
            o.eventEmitter && (e ? t ? o.eventEmitter.removeListener(e, t) : o.eventEmitter.removeAllListeners(e) : o.eventEmitter.reset())
        }
        ,
        on: (e, t) => {
    ...
    const kn = ["swal-title", "swal-html", "swal-footer"]
        , Bn = e => {
            ...
            return Array.from(e.querySelectorAll("swal-param")).forEach(e => {
                ...
                n && o && (t[n] = n in zt && "boolean" == typeof zt[n] ? "false" !== o : n in zt && "object" == typeof zt[n] ? JSON.parse(o) : o)
            }
            ),
                t
        }
        ...
        , Tn = e => {
            ...
            n && (Mn(n, ["type", "label", "placeholder", "value"]),
        ...
        , Hn = e => {
            ...
            if (Vn(i, s, e),
                setTimeout(() => {
                    ...
                    , 10),
                D() && (Dn(i, void 0 !== e.scrollbarPadding && e.scrollbarPadding, r),
                    (() => {
                        const e = y();
                ...
                ot && !1 === e.backdrop && s.scrollHeight > i.clientHeight && (i.style.pointerEvents = "auto"),
        ...
        , jn = e => {
            ...
            if (!t || e.target !== t)
                return;
            const n = y();
            n && (t.removeEventListener("animationend", jn),
                t.removeEventListener("transitionend", jn),
                n.style.overflowY = "auto",
                W(n, r["no-transition"]))
        }
        , In = (e, t) => {
            ne(t) ? (e.style.overflowY = "hidden",
                t.addEventListener("animationend", jn),
                t.addEventListener("transitionend", jn)) : e.style.overflowY = "auto"
        }
        , Dn = (e, t, n) => {
            (() => {
        ...
        , Vn = (e, t, n) => {
            var o;
            null !== (o = n.showClass) && void 0 !== o && o.backdrop && z(e, n.showClass.backdrop),
                n.animation ? (t.style.setProperty("opacity", "0", "important"),
                    X(t, "grid"),
                    setTimeout(() => {
                        var e;
                        null !== (e = n.showClass) && void 0 !== e && e.popup && z(t, n.showClass.popup),
    ...
    function _n(e) {
        !function (e) {
            e.inputValidator || ("email" === e.input && (e.inputValidator = qn),
    ...
    class Un {
        ...
        _main(e, t = {}) {
            ...
            _n(n),
                Object.freeze(n),
                o.timeout && (o.timeout.stop(),
                    delete o.timeout),
                clearTimeout(o.restoreFocusTimeout);
            const i = Kn(Fn);
            return Fe(Fn, n),
                me.innerParams.set(Fn, n),
                zn(Fn, i, n)
        }
        then(e) {
    ...
    const zn = (e, t, n) => new Promise((i, s) => {
        ...
        et.swalPromiseResolve.set(e, i),
            ...
            ((e, t) => {
                "select" === t.input || "radio" === t.input ? kt(e, t) : ["text", "email", "number", "tel", "textarea"].some(e => e === t.input) && (g(t.inputValue) || b(t.inputValue)) && (vt(P()),
                    Bt(e, t))
            }
            )(e, n),
            Hn(n),
        ...
        , Wn = (e, t) => {
            ...
            return o.showClass = Object.assign({}, zt.showClass, o.showClass),
        ...
        , Kn = e => {
            ...
            return me.domCache.set(e, t),
                t
        }
        , Yn = (e, t, n) => {
            const o = H();
            Z(o),
                t.timer && (e.timeout = new En(() => {
                    n("timer"),
                        delete e.timeout
                }
                    , t.timer),
                    t.timerProgressBar && o && (X(o),
        ...
        , Xn = (e, t) => {
            if (!t.toast)
                return h(t.allowEnterKey) ? void (Zn(e) || Jn(e, t) || We(-1, 1)) : (m("allowEnterKey", "preConfirm: () => false"),
                    void e.popup.focus())
        }
        , Zn = e => {
        ...
        , Jn = (e, t) => t.focusDeny && ee(e.denyButton) ? (e.denyButton.focus(),
            !0) : t.focusCancel && ee(e.cancelButton) ? (e.cancelButton.focus(),
                !0) : !(!t.focusConfirm || !ee(e.confirmButton)) && (e.confirmButton.focus(),
                    !0);
